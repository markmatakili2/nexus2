...
export const GenerateReportsPage: React.FC<GenerateReportsPageProps> = (props) => {
    ...
    const allReportsData = useMemo((): (ReportData | null)[] => {
        ...
        return filteredStudents.map(student => {
            ...
            const performanceHistory = getStudentPerformanceHistory(student.id, activeTerm, props.students, props.terms, props.classes, props.activeSubjects, props.marks, props.examSessions, props.users, props.subjects);

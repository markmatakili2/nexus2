...
import { SchoolClass, Term, Student, Subject, Mark, ExamSession, User, UserRole } from '../../types';
...
export const AdminClassBroadsheetPage: React.FC<AdminClassBroadsheetPageProps> = ({
  classes, terms, students, subjects, activeSubjects, marks, examSessions, users, currentUser, currentTermId, actualSchoolName, schoolBadgeUrl, schoolMotto
}) => {

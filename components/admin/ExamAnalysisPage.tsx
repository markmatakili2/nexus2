...
export const AdminExamAnalysisPage: React.FC<AdminExamAnalysisPageProps> = ({
  classes, terms, students, users, subjects, activeSubjects, marks, examSessions, currentTermId, currentUser, actualSchoolName, schoolBadgeUrl, schoolMotto
}) => {
                            ...
                            <div key={subjectAnalysis.subjectId} className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-3 text-center">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-bold text-xl text-gray-800 dark:text-slate-100">{calculateSubjectGradeAndPoints(subjectAnalysis.meanScore, subjectAnalysis.subjectId).grade}</div>
                                    </div>
                                    <div>

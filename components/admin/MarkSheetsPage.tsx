...
export const AdminMarkSheetsPage: React.FC<AdminMarkSheetsPageProps> = ({
  classes, students, activeSubjects, terms, examSessions, currentTermId, actualSchoolName, marks, schoolBadgeUrl, schoolMotto
}) => {
        ...
        <div className="print-only mb-4">
            <div className="print-header-container">
                ...
                <div className="print-header-text">
                    <div className="font-bold">{actualSchoolName}</div>
                    <div>{printableTitle}</div>
                    <div>{activeTerm?.name} - {activeTerm?.year}</div>
                </div>
            </div>

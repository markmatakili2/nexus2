...
import { User, Student, Term, SchoolClass, Mark, ExamSession, Subject, UserRole } from '../types';
...
export const DashboardPage: React.FC<DashboardPageProps> = ({
    currentUser, users, students, currentTermId, terms, classes, activeSubjects, marks, examSessions, actualSchoolName, schoolAddress, subjects, schoolBadgeUrl
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {currentUser.roles.includes(UserRole.PARENT) && parentChild && activeTerm && (
             <div className="col-span-1 md:col-span-2 lg:col-span-3 mt-6 relative"> 
                ...
                <ReportDisplay report={parentReport} performanceHistory={parentPerformanceHistory} actualSchoolName={actualSchoolName} schoolAddress={schoolAddress} userRoles={currentUser.roles} schoolBadgeUrl={schoolBadgeUrl} />
            </div>
          )}
        </div>

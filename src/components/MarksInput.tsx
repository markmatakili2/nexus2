...
interface MarksInputProps {
  ...
  currentUserRoles: UserRole[]; // To control editing capabilities
}
...
export const MarksInput: React.FC<MarksInputProps> = ({
  ...
  const isTeacherOnly = currentUserRoles.includes(UserRole.TEACHER) && !currentUserRoles.includes(UserRole.ADMIN);
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700 border border-gray-200 dark:border-slate-700 rounded-md">
                ...
                <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                  {filteredStudents.map(student => {
                    ...
                    const isDisabledByRole = isTeacherOnly && isMarkSubmitted;

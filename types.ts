...
export interface User {
  ...
  schoolId?: string; // To associate user with a school. Optional for superadmin.
  isBoardMember?: boolean;
}

export type TeacherFormData = Omit<User, 'id' | 'studentId' | 'profileImageUrl' | 'signatureImageUrl' | 'schoolId'> & { id?: string, password_param?: string };
...
export type StudentFormData = Omit<Student, 'id' | 'profileImageUrl' | 'schoolId'> & { id?: string, profileImageFile?: File | null };
